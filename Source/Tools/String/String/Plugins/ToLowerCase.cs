...
namespace PZone.StringTools.Plugins
{
    ...
    public class ToLowerCase : AttributesProcessing, IPlugin
    {
        /// <inheritdoc />
        public ToLowerCase(string unsecureConfig) : base(unsecureConfig)
        {
        }
        ...
        {
            SetValues(context, value => value.ToLower());
        }
    }
}