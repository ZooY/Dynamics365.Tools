...
namespace PZone.StringTools.Plugins
{
    ...
    public class ToUpperCase : AttributesProcessing, IPlugin
    {
        /// <inheritdoc />
        public ToUpperCase(string unsecureConfig) : base(unsecureConfig)
        {
        }
        ...
        {
            SetValues(context, value => value.ToUpper());
        }
    }
}